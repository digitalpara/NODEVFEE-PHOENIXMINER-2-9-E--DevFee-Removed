...
PhoenixMiner.exe -pool eu1.ethermine.org:4444 -pool2 eu1.ethermine.org:4444 -wal 0x7F5BB53c415334235a9E42eA03695F11b6553C0D.rig4 -pass x -nvidia -proto 3 -ftimeout 120 -cdm 0 -log 0 -minRigSpeed 102.000 -rmode 2 -coin eth -coin2 eth -timeout 2500 -tstop 80 -tstart 70 -rate 0
